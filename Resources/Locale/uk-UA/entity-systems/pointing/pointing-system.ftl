...
pointing-system-point-in-own-inventory-self = Ви показуєте на ваш {$item}.
pointing-system-point-in-own-inventory-others = {CAPITALIZE($pointer)} показує на {$pointer} {$item}.
