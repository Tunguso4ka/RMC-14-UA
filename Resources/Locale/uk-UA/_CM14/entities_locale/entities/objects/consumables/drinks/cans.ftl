...
ent-CMDrinkCanMountainWind = моунтейн вінд
    .desc = Продуває тебе наскрізь, прямо як космічне повітря

ent-CMDrinkCanThirteenLoko = тринадцяте локо
    .desc = Споживання Тринадцятого Локо може викликати: судоми, сліпоту, сп'яніння, смерть. Будь ласка, пійте відповідально.

ent-CMDrinkCanDrGibb = доктор гібб
    .desc = Найсмачніша мікстура 42 різних смаків хімікатів які ти не можеш виговорити.

ent-CMDrinkCanStarkist = стар-кіст
    .desc = Смак зірки в формі рідини. Та, трохи тюни...?

ent-CMDrinkCanSpaceUp = спейс-ап
    .desc = На смак як розгерма у твоєму роті.

ent-CMDrinkCanLemonLime = лемон-лайм
    .desc = Ти хотів апельсин. Але тобі дали лемон-лайм.

ent-CMDrinkCanIcedTea = чай зі льдом
    .desc = Улюблений напій бабці реднека з твого загону.

ent-CMDrinkCanGrape = вишневий сік
    .desc = Банка скоріше за все не вишневого соку.

ent-CMDrinkCanTonic = тонік
    .desc = "Крок перший: Тонік. Є. Крок другий: Джін."

ent-CMDrinkCanSoda = содова вода
    .desc = Банка содової. Кузен води з під крана... по словам європейців.

ent-CMDrinkCanBoda = бода
    .desc = Державно-регулюємий содовий напій. Насолоджуйтеся комаради.

ent-CMDrinkCanBodaPlyus = бода-пльюс
    .desc = Державно-регулюємий содовий напій, тепер з додатковим смаком. Насолоджуйтеся комаради.

ent-CMDrinkCanFruitBeer = фруктову пиво
    .desc = В теорії? Кореневе пиво зі смаком манго звучить як гарна ідея. Але Вейланд-Ютані знищила ще одну теорію зі своєю новою лінією коли. Консервовано корпорацією Вейланд-Ютані.
