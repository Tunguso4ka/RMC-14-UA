...
bounty-item-clown-shoes = Чоботи клоуна
bounty-item-corn = Кукурудза
bounty-item-crayon = Крейда
bounty-item-cuban-carp = Короп по Кубанські
bounty-item-diamond = Diamond
bounty-item-donk-pocket = Донк-покет
bounty-item-donut = Пончик
bounty-item-figurine = Колекційна фігурка
bounty-item-flesh-monster = М'ясний монстер
bounty-item-flower = Квітка
bounty-item-galaxythistle = Космічна розторопша
...
bounty-item-lung = Легені
bounty-item-monkey-cube = Куб з мавпою
...
bounty-item-prison-uniform = Одяг в'язня
bounty-item-radio = Рація чи Навушник
bounty-item-research-disk = Диск дослідження
...
bounty-item-toolbox = Коробка інструментів
bounty-item-tech-disk = Диск технологій
...
bounty-item-labeler = Ручний етикетник
...
bounty-item-vegetable = Овочи
bounty-item-chili = Миска чілі
...
bounty-item-cardboard-box = Картона коробка
bounty-item-wine = Бутилка вина
...
bounty-description-lasergun = The Salvage Caravan requests a large shipment of laser weapons to mop up a hive of xenonids.
