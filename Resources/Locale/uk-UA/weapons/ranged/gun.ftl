...
gun-fire-rate-examine = Скорострільність [color={$color}]{$fireRate}[/color] в секунду.
...
gun-ballistic-cycle = Наступний набій
...
gun-battery-examine = Воно має достатньо заряду на [color={$color}]{$count}[/color] пострілів.
