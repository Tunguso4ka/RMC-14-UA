id-card-access-level-command = Командування
...
id-card-access-level-research-director = Науковий Директор
id-card-access-level-research = Наука

id-card-access-level-chief-medical-officer = Головний Лікарь
id-card-access-level-medical = Медічний
...
id-card-access-level-maintenance = Техніхнічні

id-card-access-level-external = Зовнішні
