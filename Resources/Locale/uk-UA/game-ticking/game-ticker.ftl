...
game-ticker-player-join-game-message = Вітаємо на Корпусі МорПіхоти 14! Якщо це ваш перший раз, прочитайте правила та не бійтеся просити допомоги у LOOC (локальному OOC), OOC (зазвичай вимкнутий під час раунду) чи у АХелпі (F1).
game-ticker-get-info-text = Вітаємо на [color=white]Корпусі МорПіхоти 14![/color]
...
game-ticker-get-info-preround-text = Привіт і вітаємо на [color=white]Корпусі МорПіхоти 14![/color]
                            Поточний раунд: [color=white]#{$roundId}[/color]
