...
humanoid-profile-editor-preferred-armor-label = Улюблений тип броні:
humanoid-profile-editor-enable-playtime-perks = Увімкнути медалі:
humanoid-profile-editor-xeno-prefix = Префікс за ксено:
...
humanoid-profile-editor-xeno-postfix = Постфікс за ксено:
...
humanoid-profile-editor-preference-unavailable-spawn-as-overflow-button = Бути {$overflowJob} якщо обрані посади не доступні.
