...
trait-southern-name = Південно-Американський акцент (неперекладено)
trait-southern-desc = У вас трошечки інша вимова.

trait-snoring-name = Хропіння
trait-snoring-desc = Ви будете хропіти під час сну.

trait-liar-name = Патологічний брехун
trait-liar-desc = Поки інші кажуть правду й іноді брешуть, ви кажете тільки правду (правду лі? Вухахаха)

trait-cowboy-name = Акцент ковбоя (неперекладено)
trait-cowboy-desc = Ви розмовляєте з акцентом ковбоя!

trait-german-name = Німецький акцент (неперекладено)
trait-german-desc = Ви родом з космічної Німеччини.
