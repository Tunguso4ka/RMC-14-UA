...
ent-RMCGunCasePistolM13 = M13 auto-pistol case
    .desc = A gun case containing the necessary attachments to assemble a custom M13 auto-pistol. Comes with two extended & two extended (AP) magazines.
