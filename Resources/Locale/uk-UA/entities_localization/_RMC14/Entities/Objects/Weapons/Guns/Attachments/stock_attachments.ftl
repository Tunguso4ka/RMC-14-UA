...
ent-RMCAttachmentM54CStockCollapsibleWhite = { ent-RMCAttachmentM54CStockCollapsible }
    ...
    .suffix = White Camo
ent-RMCAttachmentM13StockCollapsible = M13 folding stock
    .desc = A collapsible stock custom-fitted for the M13 Auto Pistol. Enhances recoil control when deployed, while maintaining compactness for close-quarters use.
ent-RMCAttachmentM13StockSolid = M13 solid stock
    .desc = A fixed polymer stock designed exclusively for the M13 Auto Pistol, improving stability during sustained fire.
...
ent-RMCAttachmentL24Stock = L24 solid stock
    .desc = Intergrated into the L24. You shouldn't have this.
ent-RMCAttachmentL24BStock = L24B solid stock
    .desc = Intergrated into the L24B. You shouldn't have this.
ent-RMCAttachmentL83A3Stock = L83A3 solid stock
