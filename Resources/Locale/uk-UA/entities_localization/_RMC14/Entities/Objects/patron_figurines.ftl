...
ent-RMCFigurinePatronSips-On-Puddles = Sips-On-Puddles figurine
    .desc = Floopy ears. Small Snout. Quirky Humour.
...
ent-RMCFigurinePatronOsbornCheeseballCurry = Osborn 'Cheeseball' Curry figurine
    .desc = Under the figurine, a text is engraved that reads:
...
ent-RMCFigurinePatronAnglerAngusSeawing = Angler 'Angus' Seawing figurine
    .desc = A fish-looking dragon who is known for telling people they arent a fish.
...
ent-RMCFigurinePatronMinjiFailsafeKilgrim = Minji 'Failsafe' Kilgrim figurine
    .desc = Some stray cat usually found roaming in medbay. The figure itself smells strongly of various chemicals, small singe marks litter it as if it's been through an explosion or two.
