...
ent-ActionXenoFireSpikes = Fire Spikes (75 shards)
    .desc = Launch 8 small shards of spikes in the direction you click.
ent-ActionXenoSpikeShed = Spike Shed (all shards)
    .desc = Shred all of your shards to launch them all in all directions around yourself. Lose the bonus armor in the process while also gaining a speed boost. This will disable you from gaining any shards for 30 seconds. Requires 150 shards minimum
