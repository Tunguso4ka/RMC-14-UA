...
ent-ClothingNeckLGBTPin = значок ЛГБТК
    .desc = be gay do crime.
ent-ClothingNeckAllyPin = straight ally pin
    .desc = Be ally do crime.
ent-ClothingNeckAromanticPin = значок аромантиків
    .desc = be aro do crime.
ent-ClothingNeckAroacePin = aroace pin
    .desc = Be aroace do crime.
ent-ClothingNeckAsexualPin = значок асексуалів
    .desc = be ace do crime.
ent-ClothingNeckBisexualPin = значок бісексуалів
    .desc = be bi do crime.
ent-ClothingNeckGayPin = gay pin
    .desc = Be gay~ do crime.
ent-ClothingNeckIntersexPin = значок інтерсекс
    .desc = be intersex do crime.
ent-ClothingNeckLesbianPin = значок лесбіянок
    .desc = be lesbian do crime.
ent-ClothingNeckNonBinaryPin = значок небінарних
...
ent-ClothingNeckGoldAutismPin = золотий значок аутистів
