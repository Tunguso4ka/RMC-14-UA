...
job-greet-planet-name = Корабель наразі на орбиті {$planetName}
...
job-greet-crew-shortages = Із-за проблем з набором екіпажу вам був виданий додатковий доступ.
job-not-available-wait-in-lobby = Раунд вже розпочався, але ви не отримали жодну з ваших обраних ролей (або не обрали їх) та вибрали залишитися в лобі. Ви можете змінити це у меню кастомізації.