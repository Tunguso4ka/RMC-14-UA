delivery-recipient-examine = Цей був відправлений до {$recipient}, {$job}.
delivery-already-opened-examine = Воно вже відкрито.
delivery-earnings-examine = Delivering this will earn the station [color=yellow]{$spesos}[/color] spesos.
delivery-recipient-no-name = Невідомий
delivery-recipient-no-job = Невідома
