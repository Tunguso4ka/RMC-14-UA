hypospray-all-mode-text = Тільки переміщає
hypospray-mobs-only-mode-text = Бере та переміщує
hypospray-invalid-text = Неправильне
hypospray-volume-label = Ємність: [color=white]{$currentVolume}/{$totalVolume}u[/color]
