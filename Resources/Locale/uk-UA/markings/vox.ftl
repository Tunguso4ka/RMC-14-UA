marking-TattooVoxHeartLeftArm-heart_l_arm = Vox Left Arm Tattoo (Серце)
marking-TattooVoxHeartLeftArm = Vox Left Arm Tattoo (Серце)
marking-TattooVoxHeartRightArm-heart_r_arm = Vox Right Arm Tattoo (Серце)
marking-TattooVoxHeartRightArm = Vox Right Arm Tattoo (Серце)
marking-TattooVoxHiveChest-hive_s = Vox Chest Tattoo (вулик)
marking-TattooVoxHiveChest = Vox Chest Tattoo (вулик)
marking-TattooVoxNightlingChest-nightling_s = Vox Chest Tattoo (пташення)
marking-TattooVoxNightlingChest = Vox Chest Tattoo (пташення)
