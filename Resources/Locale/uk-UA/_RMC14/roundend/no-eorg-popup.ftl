no-eorg-popup-title = КМП14
no-eorg-popup-label = Вітаємо у Кінці Раунда
...
no-eorg-popup-close-button = Звучить!
no-eorg-popup-close-button-wait = The close button will be enabled after {$time} seconds.
no-eorg-popup-skip-checkbox = Не показувати це знов.