...
rmc-squad-info-fireteams = [bold]Вогнегрупа[/bold]
rmc-squad-info-role = [bold]Роль[/bold]
rmc-squad-info-rank = [bold]Звання[/bold]
rmc-squad-info-member = [bold]Член[/bold]
rmc-squad-info-assign-ft = [bold]Призначити ВГ[/bold]
rmc-squad-info-actions = [bold]Дії[/bold]
rmc-squad-info-squad-leader-name = [bold]Голова Загону: {$leader}[/bold]
rmc-squad-info-squad-leader-none = [bold]Голова Загону: Немає[/bold]
rmc-squad-info-team-leader-name = [bold]Голова Групи: {$leader}[/bold]
rmc-squad-info-team-leader-none = [bold]Голова Групи: Немає[/bold]
