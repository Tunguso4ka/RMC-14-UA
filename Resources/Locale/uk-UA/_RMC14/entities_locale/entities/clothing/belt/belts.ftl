...
ent-CMBeltSecurity = пояс воєнполу зразку M276
    .desc = М276 це стандарт обладнання КМП ООН. Він складається з модульного пояса та різних мішочків. Ця версія використовується Військовою Поліцією КМП ООН та миротворцями.

ent-CMBeltSmartGunner = пояс барабанного озброєння зразку M280
    .desc = Не беручи до уваги факти 1. Барабанні магазини надзвичайно не ергономічні, та 2. потребують надзвичайно точної обробки щоб легко вміщатися (спойлер, вони не вмістяться. Додаючи це до міфу про "Різних Смартґанерів"), КМП ООН вирішило випустити модифікований пояс морпіхів (відомий під більш формальною назвою М280) з гачками та пилозахисними чохлами (занадто складними для звичайних бовдурів) для системи барабанної амуніції М56В. Коли фіксатор не застрягає в замазаною мастилом по горло липучці, то цей пояс виконує доволі не погану роботу зберігаючи достатню кількість барабанів. Але ставлячи крапку - в порівнянні зі стандартними поясами... цей смо-кче. Але ж, слово "смоктати" описує буття кожного Морпіху, чи я неправий?
