...
ent-CMPosterSynthetic2 = Синтет
    .desc = Гей, Синтети! Вони вже є вітром давно минулого. Компанія Ве-Я викупила їх приблизно тоді, коли одна з їхніх космічних станцій зійшла з орбіти і впала в гравітаційний колодязь планети після збою в роботі систем.

ent-CMPosterKoorlander = курландер золоті
    .desc = Курландер Золоті, закатані машиною з любов'ю заради ВАШОЇ насолоди.

ent-CMPosterSynthetic = ВИ ЗАВЖДИ ВПІЗНАЄТЕ СИНТЕТА
    .desc = ВИ ЗАВЖДИ ВПІЗНАЄТЕ СИНТЕТА. ВИ ЗАВЖДИ ВПІЗНАЄТЕ СИНТЕТА. ВИ ЗАВЖДИ ВПІЗНАЄТЕ СИНТЕТА. ВИ ЗАВЖДИ ВПІЗНАЄТЕ СИНТЕТА. ВИ ЗАВЖДИ ВПІЗНАЄТЕ СИНТЕТА
