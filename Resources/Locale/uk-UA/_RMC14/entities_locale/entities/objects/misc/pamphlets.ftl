...
ent-CMPamphletEngineer = інженерний памфлет-інструкція
    .desc = Памфлет який може надати потрібні вам знання. This one has an engineering insignia.

ent-CMPamphletJTAC = JTAC памфлет-інструкція
    .desc = Памфлет який може надати потрібні вам знання. This one has the image of a radio on it.

ent-CMPamphletSpotter = памфлет-інструкція спостерегача
    .desc = Памфлет який може надати потрібні вам знання. This one has the image of a pair of binoculars on it.

ent-CMPamphletPowerloader = памфлет-інструкція енергозавантажувача
    .desc = Памфлет який може надати потрібні вам знання. This one has a powerloader insignia. The title reads 'Moving freight and squishing heads - a practical guide to Caterpillar P-5000 Work Loader'.

ent-CMPamphletPolice = памфлет-інструкція воєнполу
    .desc = Памфлет який може надати потрібні вам знання. This one has the image of a radio on it.

ent-CMPamphletSurgery = памфлет-інструкція хірургії
    .desc = Памфлет який може надати потрібні вам знання. This one has a medical insignia.
