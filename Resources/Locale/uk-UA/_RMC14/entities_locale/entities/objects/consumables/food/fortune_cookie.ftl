ent-CMFortuneCookie = печивко з передбаченням
    .desc = Золотисто-бруде печивко з перебаченням. Деяки кажуть що папірець у ньому має можливість передбачити майбутнє.
