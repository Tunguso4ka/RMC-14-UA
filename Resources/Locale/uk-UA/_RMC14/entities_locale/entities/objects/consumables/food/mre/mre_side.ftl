...
ent-CMMREFoodCracker = крекер
    .desc = Вміст стандартного сухпайка КМП ООН. Цій -  крекер.

ent-CMMREFoodRiceOnigiri = рисове онігірі
    .desc = Вміст стандартного сухпайка КМП ООН. Цій -  рисове онігірі.

ent-CMMREFoodMashedPotatoes = картопляне пюре
    .desc = Вміст стандартного сухпайка КМП ООН. Цій -  картопляне пюре.

ent-CMMREFoodRisotto = ризото
    .desc = Вміст стандартного сухпайка КМП ООН. Цій -  ризото.
