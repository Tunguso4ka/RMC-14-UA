ent-RMCBaseGunCase = base gun case
    .desc = A gun case.

ent-RMCSmartPistolCase = SU-6 smart pistol case
    .desc = A gun case containing the SU-6 smart pistol. Comes with a full belt holster.

ent-RMCMK80Case = MK80 pistol case
    .desc = A gun case containing the MK80. Comes with two magazines.

ent-RMCM54CE2Case = M54CE2 heavy assault rifle case
