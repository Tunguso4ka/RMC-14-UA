...
particle-accelerator-control-menu-power-label = Живлення:
particle-accelerator-control-menu-strength-label = Міць:
particle-accelerator-control-menu-alarm-control = PARTICLE STRENGTH
                                                  LIMITER FAILURE
particle-accelerator-control-menu-scan-parts-button = Просканувати
