...
reagent-name-iced-green-tea = зелений чай з льодом
reagent-desc-iced-green-tea = cold green tea.

reagent-name-iced-tea = чай з льодом
reagent-desc-iced-tea = No relation to a certain rap artist/actor.

reagent-name-lemonade = лемонад
...
reagent-name-milk-goat = козлине молоко
...
reagent-name-hot-cocoa = горячий шоколад
reagent-desc-hot-cocoa = Smells like the holidays!

reagent-name-soda-water = газованка
...
reagent-name-ice = льод
reagent-desc-ice = Змерзла вода.

reagent-name-dry-ramen = сухий рамен
reagent-desc-dry-ramen = Dry noodles and salt.

reagent-name-hot-ramen = горячий рамен
...
reagent-desc-mopwata = Брудна, застійна вода з швабри.