...
reagent-desc-vodka = Clear distilled alcoholic beverage that originates from Poland.

reagent-name-whiskey = віски
...
reagent-name-antifreeze = антифріз
reagent-desc-antifreeze = Ultimate refreshment.

reagent-name-atomic-bomb = ядерна бомба
...
reagent-name-blue-hawaiian = синій гаваєц
...
reagent-name-banana-honk = банановий хонк
...
reagent-name-black-russian = чорнорус
...
reagent-name-cuba-libre = вільна куба
reagent-desc-cuba-libre = Ром, що змішан із колою. Віва ля революс'йон!

reagent-name-demons-blood = кров демонів
reagent-desc-demons-blood = АРРГГХХ!!!!

reagent-name-devils-kiss = поцілунок дідька
reagent-desc-devils-kiss = Creepy time!

reagent-name-doctors-delight = докторська насолода
reagent-desc-doctors-delight = A gulp a day keeps the MediBot away. That's probably for the best.

reagent-name-driest-martini = сухейше мартіні
...
reagent-name-kira-special = кіра особлива
